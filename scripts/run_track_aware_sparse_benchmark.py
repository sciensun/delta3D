...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--teachers', nargs='+', default=['body_roundness','ear_expansion','trunk_bending']); ap.add_argument('--modes', nargs='+', default=['track_dropout','exact_k_views_per_track','baseline_maximized_k_views']); ap.add_argument('--fractions', nargs='+', type=float, default=[.1,.2,.4,.6]); ap.add_argument('--seeds', nargs='+', type=int, default=[11,29,47,71,97]); ap.add_argument('--views_per_track', type=int, default=2); args=ap.parse_args()
            ...
            for fraction in args.fractions:
                for seed in args.seeds:
                    ...
                    records.append({"teacher":teacher_name,"mode":mode,"fraction":fraction,"views_per_track":args.views_per_track,
                        ...
                        "seed":seed,"noise":0.0,"outlier_rate":0.0,"solver":"symmetric_graph_irls",
                        "control_count":None,
